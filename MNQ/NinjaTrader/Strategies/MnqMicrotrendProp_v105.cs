...
{
	/// <summary>
	/// MNQ Microtrend Prop v1.05 – Pullback103 preset (v103 + PullbackBreak + L+S).
	/// Nová třída kvůli NT cache staré rozbité v104. Backtest 6M2026: PF 1.22, ~274 obch.
	/// </summary>
	public class MnqMicrotrendProp_v105 : Strategy
	{
		...
		protected override void OnStateChange()
		{
			...
			{
				Description = "MNQ Microtrend v1.05 – Pullback103 preset, SL 130/PT 182, TICK 200.";
				Name = "MnqMicrotrendProp_v105";
		...
		private void LogPreset()
		{
			if (presetLogged) return;
			presetLogged = true;
			Print(string.Format(
				"{0} PRESET_PULLBACK103 | Entry={1} L={2} S={3} SL/PT={4}/{5} SessionBias={6} MaxTrades={7} Margin={8} Body={9}",
				Name, EntryMode, EnableLong, EnableShort, StopLossTicks, ProfitTargetTicks,
				SessionBias, MaxTradesPerDay, PriorBarMarginTicks, MinTrendBodyTicks));
		}
		#endregion
