...
{
	/// <summary>
	/// MES500TSwingMapV3 — V2 + PEAK? s % pravděpodobností vrcholu swingu.
	/// </summary>
	public class MES500TSwingMapV3 : Indicator
	{
		...
		protected override void OnStateChange()
		{
			...
			{
				Description = "MES500TSwingMapV3 — PEAK? s % pravděpodobností + ◆ PEAK potvrzený výstup.";
				Name        = "MES500TSwingMapV3";
		...
		private void UpdateActionPanel()
		{
			...
			Draw.TextFixed(this, "MES500TSMV3_Action", text,
		...
		private void DrawEntryMarker(SwingDir dir)
		{
			...
			string barTag = "MES500TSMV3_Entry_" + CurrentBar;
		...
		private void DrawPeakSoftMarker(SwingDir dir)
		{
			...
			string barTag = "MES500TSMV3_PeakSoft_" + CurrentBar;
		...
		private void DrawPeakConfirmedMarker(SwingDir dir)
		{
			...
			string barTag = "MES500TSMV3_Peak_" + CurrentBar;
		...
		private void DrawSwingLine(int barA, double priceA, int barB, double priceB)
		{
			...
			string tag = "MES500TSMV3_Line_" + barA + "_" + barB;
...
namespace NinjaTrader.NinjaScript.Indicators
{
	...
	{
		private MES500TSwingMapV3[] cacheMES500TSwingMapV3;
		public MES500TSwingMapV3 MES500TSwingMapV3(int minSwingTicks, double correctionRatio, int confirmBars, int atrPeriod, double atrMultiplier, bool showSwingLines, bool showStrengthPanel, bool showActionPanel, bool showEntryMarkers, bool showEntryConnector, bool showPeakMarkers, bool showPeakSoftMarkers, int labelOffsetTicks, int peakMinTicks, int peakPullbackTicks, bool peakRequireBreak)
		{
			return MES500TSwingMapV3(Input, minSwingTicks, correctionRatio, confirmBars, atrPeriod, atrMultiplier, showSwingLines, showStrengthPanel, showActionPanel, showEntryMarkers, showEntryConnector, showPeakMarkers, showPeakSoftMarkers, labelOffsetTicks, peakMinTicks, peakPullbackTicks, peakRequireBreak);
		}

		public MES500TSwingMapV3 MES500TSwingMapV3(ISeries<double> input, int minSwingTicks, double correctionRatio, int confirmBars, int atrPeriod, double atrMultiplier, bool showSwingLines, bool showStrengthPanel, bool showActionPanel, bool showEntryMarkers, bool showEntryConnector, bool showPeakMarkers, bool showPeakSoftMarkers, int labelOffsetTicks, int peakMinTicks, int peakPullbackTicks, bool peakRequireBreak)
		{
			if (cacheMES500TSwingMapV3 != null)
				for (int idx = 0; idx < cacheMES500TSwingMapV3.Length; idx++)
					if (cacheMES500TSwingMapV3[idx] != null && cacheMES500TSwingMapV3[idx].MinSwingTicks == minSwingTicks && cacheMES500TSwingMapV3[idx].CorrectionRatio == correctionRatio && cacheMES500TSwingMapV3[idx].ConfirmBars == confirmBars && cacheMES500TSwingMapV3[idx].AtrPeriod == atrPeriod && cacheMES500TSwingMapV3[idx].AtrMultiplier == atrMultiplier && cacheMES500TSwingMapV3[idx].ShowSwingLines == showSwingLines && cacheMES500TSwingMapV3[idx].ShowStrengthPanel == showStrengthPanel && cacheMES500TSwingMapV3[idx].ShowActionPanel == showActionPanel && cacheMES500TSwingMapV3[idx].ShowEntryMarkers == showEntryMarkers && cacheMES500TSwingMapV3[idx].ShowEntryConnector == showEntryConnector && cacheMES500TSwingMapV3[idx].ShowPeakMarkers == showPeakMarkers && cacheMES500TSwingMapV3[idx].ShowPeakSoftMarkers == showPeakSoftMarkers && cacheMES500TSwingMapV3[idx].LabelOffsetTicks == labelOffsetTicks && cacheMES500TSwingMapV3[idx].PeakMinTicks == peakMinTicks && cacheMES500TSwingMapV3[idx].PeakPullbackTicks == peakPullbackTicks && cacheMES500TSwingMapV3[idx].PeakRequireBreak == peakRequireBreak && cacheMES500TSwingMapV3[idx].EqualsInput(input))
						return cacheMES500TSwingMapV3[idx];
			return CacheIndicator<MES500TSwingMapV3>(new MES500TSwingMapV3(){ MinSwingTicks = minSwingTicks, CorrectionRatio = correctionRatio, ConfirmBars = confirmBars, AtrPeriod = atrPeriod, AtrMultiplier = atrMultiplier, ShowSwingLines = showSwingLines, ShowStrengthPanel = showStrengthPanel, ShowActionPanel = showActionPanel, ShowEntryMarkers = showEntryMarkers, ShowEntryConnector = showEntryConnector, ShowPeakMarkers = showPeakMarkers, ShowPeakSoftMarkers = showPeakSoftMarkers, LabelOffsetTicks = labelOffsetTicks, PeakMinTicks = peakMinTicks, PeakPullbackTicks = peakPullbackTicks, PeakRequireBreak = peakRequireBreak }, input, ref cacheMES500TSwingMapV3);
		}
	}
}
...
namespace NinjaTrader.NinjaScript.MarketAnalyzerColumns
{
	...
	{
		public Indicators.MES500TSwingMapV3 MES500TSwingMapV3(int minSwingTicks, double correctionRatio, int confirmBars, int atrPeriod, double atrMultiplier, bool showSwingLines, bool showStrengthPanel, bool showActionPanel, bool showEntryMarkers, bool showEntryConnector, bool showPeakMarkers, bool showPeakSoftMarkers, int labelOffsetTicks, int peakMinTicks, int peakPullbackTicks, bool peakRequireBreak)
		{
			return indicator.MES500TSwingMapV3(Input, minSwingTicks, correctionRatio, confirmBars, atrPeriod, atrMultiplier, showSwingLines, showStrengthPanel, showActionPanel, showEntryMarkers, showEntryConnector, showPeakMarkers, showPeakSoftMarkers, labelOffsetTicks, peakMinTicks, peakPullbackTicks, peakRequireBreak);
		}
