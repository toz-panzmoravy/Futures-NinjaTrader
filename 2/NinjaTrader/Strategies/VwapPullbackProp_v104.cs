...
{
	/// <summary>
	/// VWAP Pullback Prop AOS v1.04 – MES BALANCED preset.
	/// Kompromis frekvence (v1.03) a kvality (v1.01): LONG-only, přísnější VWAP bounce,
	/// potvrzení na další svíčce, mírné filtry. Oprava: v1.03 shorty -1347 USD.
	/// </summary>
	public class VwapPullbackProp_v104 : Strategy
	{
		#region Enums
		...
		protected override void OnStateChange()
		{
			...
			{
				Description = "VWAP Pullback Prop v1.04 – MES BALANCED (LONG-only, frekvence + kvalita).";
				Name = "VwapPullbackProp_v104";
