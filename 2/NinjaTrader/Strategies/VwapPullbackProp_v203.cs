...
{
	/// <summary>
	/// VWAP Pullback Prop AOS v2.03 – v201 + blok 16h, end 20:00, overnight flat fix.
	/// Max 5 obch/den (15:xx jádro), SL 60 / PT 65, TICK 125.
	/// </summary>
	public class VwapPullbackProp_v203 : Strategy
	{
		#region Enums
		...
		protected override void OnStateChange()
		{
			...
			{
				Description = "VWAP Pullback Prop v2.03 – blok 16,17,19h, end 20:00, SL 60 / PT 65, max 5 obch/den.";
				Name = "VwapPullbackProp_v203";
		...
		protected override void OnBarUpdate()
		{
			...
			{
				ExitAllPositions("SessionOpenFlat");
				ResetSetupState();
				return;
			}
		...
		protected override void OnExecutionUpdate(Execution execution, string executionId, double price, int quantity, MarketPosition marketPosition, string orderId, DateTime time)
		{
			...
			bool isExit = execution.Order.Name == "Stop loss" || execution.Order.Name == "Profit target"
				...
				|| execution.Order.Name == "SessionOpenFlat";
