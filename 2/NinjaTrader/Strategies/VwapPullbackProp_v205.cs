...
{
	/// <summary>
	/// VWAP Pullback Prop AOS v2.05 – produkční preset (opti1+2, TICK 125, Apex 25K EOD).
	/// v204 + SL 65/PT 65, DailyLoss 325, DailyProfit 150, MaxConsecLoss 2.
	/// Backtest 01–06/2026: +2 475 $, PF 2.22, DD −586 $, 85 obch.
	/// </summary>
	public class VwapPullbackProp_v205 : Strategy
	{
		#region Enums
		...
		protected override void OnStateChange()
		{
			...
			{
				Description = "VWAP Pullback Prop v2.05 FINAL – opti preset, SL/PT 65, risk 325/150/2, TICK 125.";
				Name = "VwapPullbackProp_v205";
