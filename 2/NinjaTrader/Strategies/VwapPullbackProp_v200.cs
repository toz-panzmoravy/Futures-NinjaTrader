...
{
	/// <summary>
	/// VWAP Pullback Prop AOS v2.00 – PROP 25k preset (TICK 125).
	/// Kompromis frekvence, win rate, profitu a DD pro eval účet ~$25 000.
	/// Cíl: $1 500 profit, max DD $500, min 5 obchodních dní.
	/// </summary>
	public class VwapPullbackProp_v200 : Strategy
	{
		#region Enums
		...
		protected override void OnStateChange()
		{
			...
			{
				Description = "VWAP Pullback Prop v2.00 – PROP 25k (TICK 125), SL 52 / PT 72, DD ochrana.";
				Name = "VwapPullbackProp_v200";
				...
				EntryEndTime = DateTime.Parse("20:45", CultureInfo.InvariantCulture);
