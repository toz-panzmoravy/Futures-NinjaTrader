...
{
	/// <summary>
	/// VWAP Pullback Prop AOS v2.01 – kvalita nad frekvencí (TICK 125).
	/// Oprava v200: přísnější filtry, max 5 obch/den, SL 60 / PT 65.
	/// </summary>
	public class VwapPullbackProp_v201 : Strategy
	{
		#region Enums
		...
		protected override void OnStateChange()
		{
			...
			{
				Description = "VWAP Pullback Prop v2.01 – kvalita (TICK 125), SL 60 / PT 65, max 5 obch/den.";
				Name = "VwapPullbackProp_v201";
