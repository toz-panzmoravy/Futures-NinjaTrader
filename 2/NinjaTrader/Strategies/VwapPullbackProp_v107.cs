...
{
	/// <summary>
	/// VWAP Pullback Prop AOS v1.07 – širší okno + optimalizované SL/PT z Analyzeru.
	/// End 21:00, blok jen 17h, SkipFirst 5 min, 4 loss stop, SL 65t / PT 60t.
	/// </summary>
	public class VwapPullbackProp_v107 : Strategy
	{
		#region Enums
		...
		protected override void OnStateChange()
		{
			...
			{
				Description = "VWAP Pullback Prop v1.07 – širší okno (end 21:00, blok 17), SL 65 / PT 60 tick.";
				Name = "VwapPullbackProp_v107";
		...
		private void ValidateTickChart()
		{
			...
			if (BarsPeriod.BarsPeriodType != BarsPeriodType.Tick)
				Print(string.Format("{0}: Optimalizováno pro TICK graf, aktuálně: {1}.", Name, BarsPeriod.BarsPeriodType));
